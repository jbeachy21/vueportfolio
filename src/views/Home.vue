<template>
  ...
  justify-content: center;">
    ...
    <img src="../assets/originalcert.png" alt="Certificate image" style="max-height:160px;max-width:160px;">
    <img src="../assets/dataviscert.png" alt="Certificate image" style="max-height:160px;max-width:160px;">
